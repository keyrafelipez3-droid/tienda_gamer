...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box;}
        body{background:#070711;color:#fff;font-family:'Inter',sans-serif;min-height:100vh;display:flex;align-items:center;justify-content:center;position:relative;overflow:hidden;padding:20px 0;}
        ...
        .auth-wrapper{width:100%;max-width:480px;padding:20px;position:relative;z-index:1;}
        ...
        .form-input.is-valid{border-color:#00ff88;}
        ...
        .field-hint{font-size:0.72rem;color:#444;margin-top:6px;display:flex;align-items:center;gap:4px;}
        .field-hint.ok{color:#00ff88;}
        .field-hint.err{color:#ef4444;}
        .pass-strength{height:3px;border-radius:2px;margin-top:8px;background:#1a1a2e;overflow:hidden;}
        ...
        .btn-submit:disabled{background:#1a1a2e;color:#444;cursor:not-allowed;transform:none;box-shadow:none;}
        ...
        .benefits{background:#111120;border:1px solid #1a1a2e;border-radius:12px;padding:16px;margin-top:20px;}
        .benefits-title{font-size:0.72rem;color:#555;text-transform:uppercase;letter-spacing:1px;margin-bottom:10px;}
        .benefit-item{display:flex;align-items:center;gap:8px;font-size:0.78rem;color:#777;margin-bottom:6px;}
        .benefit-item:last-child{margin-bottom:0;}
        .benefit-item i{color:#00ff88;font-size:0.9rem;flex-shrink:0;}
    </style>
</head>
<body>
        ...
        <form action="../../controllers/auth_controller.php" method="POST" id="registerForm">
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-input" placeholder="Tu nombre completo" required autocomplete="name">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="email" name="correo" id="correo" class="form-input" placeholder="tu@correo.com" required autocomplete="email">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="password" name="contrasena" id="pass1" class="form-input" placeholder="Mínimo 6 caracteres" required autocomplete="new-password">
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="password" name="confirmar" id="pass2" class="form-input" placeholder="Repite tu contraseña" required autocomplete="new-password">

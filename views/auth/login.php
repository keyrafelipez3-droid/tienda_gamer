            ...
            <form action="../../controllers/auth_controller.php" method="POST" id="loginForm">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="email" name="correo" class="form-input" placeholder="tu@correo.com"
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="password" name="contrasena" id="passLogin" class="form-input"
                            placeholder="Tu contraseña" pattern=".{6,}"

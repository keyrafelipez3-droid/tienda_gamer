...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        /* ITEM CARD */
        .cart-item{background:#0d0d1a;border:1px solid #1a1a2e;border-radius:16px;padding:20px;margin-bottom:12px;transition:all 0.2s;}
        .cart-item:hover{border-color:#2a2a3e;}
        .item-img{width:80px;height:80px;border-radius:12px;background:#111120;display:flex;align-items:center;justify-content:center;font-size:2rem;overflow:hidden;border:1px solid #1a1a2e;flex-shrink:0;}
        .item-img img{width:100%;height:100%;object-fit:cover;}
        .item-name{font-weight:700;font-size:0.95rem;margin-bottom:2px;}
        .item-brand{font-size:0.78rem;color:#555;}
        .item-cat{display:inline-block;background:rgba(0,255,136,0.06);border:1px solid rgba(0,255,136,0.12);color:#00ff88;border-radius:6px;padding:2px 8px;font-size:0.7rem;font-weight:600;margin-top:4px;}
        .item-price{font-size:0.875rem;color:#555;margin-top:6px;}
        .qty-control{display:flex;align-items:center;gap:8px;}
        .qty-btn{width:30px;height:30px;border-radius:8px;background:#111120;border:1px solid #1a1a2e;color:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer;transition:all 0.2s;font-size:0.9rem;}
        .qty-btn:hover{border-color:#00ff88;color:#00ff88;}
        .qty-input{width:50px;background:#111120;border:1px solid #1a1a2e;color:#fff;border-radius:8px;padding:4px;text-align:center;font-size:0.875rem;}
        .qty-input:focus{outline:none;border-color:#00ff88;}
        .item-subtotal{font-size:1.1rem;font-weight:800;color:#00ff88;text-align:right;}
        .item-remove{background:rgba(239,68,68,0.08);border:1px solid rgba(239,68,68,0.2);color:#ef4444;border-radius:8px;padding:6px 10px;cursor:pointer;transition:all 0.2s;font-size:0.82rem;}
        .item-remove:hover{background:rgba(239,68,68,0.15);}

        /* SUMMARY */
        .summary-card{background:#0d0d1a;border:1px solid #1a1a2e;border-radius:16px;padding:24px;position:sticky;top:80px;}
        .summary-title{font-size:1rem;font-weight:700;margin-bottom:20px;padding-bottom:16px;border-bottom:1px solid #1a1a2e;}
        ...
        .summary-divider{border:none;border-top:1px solid #1a1a2e;margin:16px 0;}
        ...
        .summary-total .value{font-size:1.8rem;font-weight:800;color:#00ff88;}
        .btn-checkout{background:#00ff88;color:#000;font-weight:800;border:none;border-radius:12px;padding:14px;width:100%;font-size:1rem;transition:all 0.2s;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;}
        .btn-checkout:hover{background:#00cc6a;transform:translateY(-1px);box-shadow:0 6px 20px rgba(0,255,136,0.3);}
        .btn-clear{background:transparent;border:1px solid #1a1a2e;color:#555;border-radius:10px;padding:10px;width:100%;font-size:0.82rem;cursor:pointer;transition:all 0.2s;margin-top:8px;}
        .btn-clear:hover{border-color:#ef4444;color:#ef4444;}

        /* EMPTY */
        .empty-cart{text-align:center;padding:80px 20px;}
        .empty-cart-icon{font-size:5rem;display:block;margin-bottom:20px;opacity:0.3;}
        .empty-cart h3{font-size:1.3rem;font-weight:700;margin-bottom:8px;color:#666;}
        .empty-cart p{color:#444;font-size:0.875rem;margin-bottom:24px;}
        ...
        .btn-shop:hover{background:#00cc6a;transform:translateY(-1px);color:#000;}
        .secure-badges{display:flex;gap:16px;justify-content:center;margin-top:20px;flex-wrap:wrap;}
        .secure-badge{display:flex;align-items:center;gap:6px;font-size:0.75rem;color:#444;}
                        ...
                        <div class="d-flex flex-column align-items-end gap-3">
                            ...
                            <form method="POST" class="d-flex align-items-center gap-2">
                                ...
                                <div class="qty-control">
                                    <button type="submit" name="actualizar" class="qty-btn" onclick="this.form.cantidad.value=Math.max(1,parseInt(this.form.cantidad.value)-1)">
                                        <i class="bi bi-dash"></i>
                                    </button>
                                    <input type="number" name="cantidad" class="qty-input" value="<?= $item['cantidad'] ?>" min="1" max="<?= $item['stock'] ?>">
                                    <button type="submit" name="actualizar" class="qty-btn" onclick="this.form.cantidad.value=Math.min(<?= $item['stock'] ?>,parseInt(this.form.cantidad.value)+1)">

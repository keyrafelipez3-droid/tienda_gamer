...
<div style="background:#181818;border-radius:10px;padding:14px 16px;margin-bottom:8px;display:flex;align-items:center;gap:12px;">
    <div style="width:46px;height:46px;border-radius:8px;background:#111111;display:flex;align-items:center;justify-content:center;font-size:1.3rem;overflow:hidden;border:1px solid #252525;flex-shrink:0;">
        <?php if($d['imagen']): ?>
    ...
    <div style="text-align:right;flex-shrink:0;">
        <div style="color:#d4a843;font-weight:700;">Bs. <?= number_format($d['subtotal'],2) ?></div>
    </div>
</div>
<?php endwhile; endif; ?>